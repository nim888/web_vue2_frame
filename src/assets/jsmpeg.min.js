...
JSMpeg.Source.WebSocket = function() {
    ...
    var WSSource = function(url, options) {
        ...
        //     options.socket = {};
        // }
        //options.socket.on = WSSource.prototype.on;
    };
    ...
    WSSource.prototype.start = function() {
        ...
        if (!this.socket) {
            ...
            var onOpen = this.socket.onopen
            this.socket.onopen = function(evt) {
                this.onOpen.call(this, evt);
                onOpen.call(this, evt);
            }.bind(this)

            var onMesaage = this.socket.onmessage
            this.socket.onmessage = function(evt) {
                this.onMessage.call(this, evt);
                onMesaage.call(this, evt);
            }.bind(this)
        }
    ...
    WSSource.prototype.onOpen = function(evt) {
    ...
    WSSource.prototype.onMessage = function(evt) { if (this.destination) { this.destination.write(evt.data) } };

    // WSSource.prototype.on = {};
    // WSSource.prototype.on.onopen = function(evt) {
    // }
    return WSSource
}();
